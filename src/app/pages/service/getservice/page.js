          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Manage all your services from http://localhost:4000</p>
              </div>
            </div>
          ...
          {error && (
            <div className="mt-4 bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-red-600 text-sm mt-1">Make sure your server is running on http://localhost:4000</p>
              </div>
            </div>
          )}
        </div>
